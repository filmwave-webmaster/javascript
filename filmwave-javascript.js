...
/* ============================================================
   CREATE PLAYLIST: DRAG & DROP COVER IMAGE (non-breaking)
   - Dropzone: .new-playlist-upload-field
   - Updates: .new-plalyist-upload-field-text (filename + color #191919)
   - Removes: .new-playlist-file-icon
   - Does NOT touch existing .add-cover-image click uploader
   ============================================================ */
