// MINIMAL BARBA TEST - Add this at the very top
console.log('🔍 Script loaded');

if (typeof barba !== 'undefined') {
  console.log('✅ Barba library exists');
  ...
  barba.init({
    ...
    transitions: [{
      ...
      after(data) {
        ...
        if (window.Webflow) {
          console.log('Webflow exists, resetting...');
  ...
  console.error('❌ Barba library NOT found!');
}
