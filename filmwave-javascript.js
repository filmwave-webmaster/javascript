...
/**
 * ============================================================
 * SMART SEARCH - Natural Language with Compromise.js
 * ============================================================
 */

// All searchable tags from your music library
const KNOWN_TAGS = [
  // Genres
  ...
  'trap', 'lo-fi', 'lofi', 'chillhop', 'synthwave', 'retrowave', 'metal', 'punk',
  'alternative', 'reggae', 'latin', 'world', 'experimental',
  // Moods
  ...
  'epic', 'powerful', 'gentle', 'soft', 'groovy', 'funky', 'chill',
  // Themes
  ...
  'wedding', 'party', 'holiday', 'christmas', 'summer', 'travel', 'sports', 'gaming',
  // Instruments
  'piano', 'guitar', 'strings', 'violin', 'drums', 'percussion', 'bass', 'synth',
  'saxophone', 'trumpet', 'flute', 'orchestra',
  // Vocals
  'instrumental', 'vocals', 'acapella', 'rap', 'singing',
  // Other
  'background', 'focus', 'study', 'workout', 'modern', 'vintage', 'classic',
];

// Music-context semantic mappings
const MUSIC_CONTEXT_MAP = {
  // Film/video terms → music styles
  'score': ['cinematic', 'orchestral', 'classical', 'soundtrack'],
  'soundtrack': ['cinematic', 'orchestral', 'soundtrack'],
  'movie': ['cinematic', 'film', 'soundtrack'],
  'film': ['cinematic', 'soundtrack', 'orchestral'],
  'trailer': ['epic', 'cinematic', 'trailer', 'intense'],
  'commercial': ['corporate', 'upbeat', 'commercial', 'advertising'],
  'ad': ['corporate', 'commercial', 'upbeat'],
  'advertisement': ['corporate', 'commercial', 'upbeat'],
  'video': ['cinematic', 'background', 'modern'],
  'vlog': ['upbeat', 'acoustic', 'indie', 'happy'],
  'youtube': ['upbeat', 'modern', 'pop', 'energetic'],
  'podcast': ['ambient', 'minimal', 'soft', 'background'],
  'documentary': ['ambient', 'cinematic', 'atmospheric'],
  'wedding': ['romantic', 'elegant', 'emotional', 'soft'],
  'corporate': ['corporate', 'business', 'professional', 'modern'],
  'presentation': ['corporate', 'ambient', 'modern'],
  
  // Activity terms → music styles
  'workout': ['energetic', 'upbeat', 'intense', 'electronic'],
  'gym': ['energetic', 'intense', 'electronic'],
  'exercise': ['energetic', 'upbeat', 'motivational'],
  'running': ['energetic', 'upbeat', 'fast'],
  'jogging': ['energetic', 'upbeat', 'motivational'],
  'yoga': ['ambient', 'calm', 'peaceful', 'meditation'],
  'meditation': ['ambient', 'calm', 'peaceful', 'soft'],
  'meditate': ['ambient', 'calm', 'peaceful'],
  'study': ['ambient', 'lo-fi', 'chill', 'focus'],
  'studying': ['ambient', 'lo-fi', 'chill', 'focus'],
  'focus': ['ambient', 'lo-fi', 'minimal', 'concentration'],
  'concentrate': ['ambient', 'focus', 'minimal'],
  'sleep': ['ambient', 'calm', 'soft', 'peaceful'],
  'sleeping': ['ambient', 'calm', 'soft'],
  'relax': ['ambient', 'chill', 'calm', 'relaxing'],
  'relaxing': ['ambient', 'chill', 'calm', 'peaceful'],
  'chill': ['chill', 'lo-fi', 'ambient', 'relaxed'],
  'party': ['dance', 'electronic', 'upbeat', 'energetic'],
  'dancing': ['dance', 'electronic', 'upbeat', 'groovy'],
  'driving': ['rock', 'electronic', 'energetic', 'upbeat'],
  'roadtrip': ['indie', 'rock', 'upbeat', 'adventure'],
  'cooking': ['jazz', 'acoustic', 'chill', 'upbeat'],
  'dinner': ['jazz', 'acoustic', 'elegant', 'soft'],
  'gaming': ['electronic', 'epic', 'intense', 'synth'],
  'game': ['electronic', 'epic', 'intense'],
  
  // Feeling/mood terms → moods
  'scary': ['dark', 'horror', 'tension', 'suspense'],
  'spooky': ['dark', 'horror', 'halloween', 'suspense'],
  'creepy': ['dark', 'tension', 'horror', 'mysterious'],
  'frightening': ['dark', 'horror', 'tension'],
  'funny': ['playful', 'quirky', 'comedy', 'upbeat'],
  'silly': ['playful', 'quirky', 'fun', 'comedy'],
  'humorous': ['playful', 'quirky', 'comedy'],
  'serious': ['dramatic', 'cinematic', 'intense'],
  'triumphant': ['epic', 'uplifting', 'powerful', 'triumphant'],
  'victorious': ['epic', 'triumphant', 'uplifting', 'powerful'],
  'winning': ['epic', 'triumphant', 'uplifting'],
  'heartbreaking': ['sad', 'emotional', 'melancholy'],
  'heartfelt': ['emotional', 'romantic', 'soft'],
  'soothing': ['calm', 'ambient', 'soft', 'peaceful'],
  'peaceful': ['peaceful', 'calm', 'ambient', 'nature'],
  'tense': ['tension', 'suspense', 'dark', 'intense'],
  'suspenseful': ['tension', 'suspense', 'thriller'],
  'exciting': ['energetic', 'upbeat', 'intense', 'epic'],
  'beautiful': ['emotional', 'cinematic', 'orchestral', 'soft'],
  'magical': ['fantasy', 'cinematic', 'ethereal', 'dreamy'],
  'fantasy': ['cinematic', 'epic', 'orchestral', 'adventure'],
  'futuristic': ['electronic', 'synth', 'futuristic', 'sci-fi'],
  'retro': ['retro', 'vintage', 'synthwave', '80s'],
  'vintage': ['vintage', 'retro', 'classic', 'nostalgic'],
  'modern': ['modern', 'contemporary', 'pop', 'electronic'],
  
  // Genre/style shortcuts
  'beats': ['hip-hop', 'electronic', 'trap', 'beats'],
  'synths': ['electronic', 'synth', 'synthwave'],
  'strings': ['orchestral', 'classical', 'strings', 'cinematic'],
  'brass': ['orchestral', 'jazz', 'cinematic', 'brass'],
  'piano': ['piano', 'classical', 'soft', 'emotional'],
  'guitar': ['guitar', 'acoustic', 'rock', 'folk'],
  'drums': ['drums', 'percussion', 'energetic'],
  'orchestra': ['orchestral', 'classical', 'cinematic', 'epic'],
  'choir': ['choir', 'epic', 'cinematic', 'vocal'],
  'vocals': ['vocals', 'singing', 'vocal'],
  ...
  'scifi': ['electronic', 'synth', 'futuristic', 'cinematic'],
};

// Fuse.js for typo correction
...
// Correct typos using Fuse.js
function correctTypo(word) {
  if (!fuseInstance || word.length < 3) return word;
  
  const results = fuseInstance.search(word);
  if (results.length > 0 && results[0].item.tag !== word) {
    console.log(`🔧 Typo corrected: "${word}" → "${results[0].item.tag}"`);
    return results[0].item.tag;
  }
  return word;
}

// Use compromise.js to extract meaningful terms and expand the search
function expandSearchQuery(query) {
  ...
  if (typeof nlp !== 'undefined') {
    ...
    normalizedQuery.split(/\s+/).forEach(word => {
      if (word.includes('-')) {
        expandedTerms.add(word); // Keep original: hip-hop
        expandedTerms.add(word.replace(/-/g, ' ')); // Add: hip hop
  ...
  // Log expansion
  if (expandedTerms.size > originalKeywords.length) {
    console.log(`🔍 Search: "${normalizedQuery}"`);
    console.log(`   Expanded to: [${Array.from(expandedTerms).join(', ')}]`);
  }
...
function applyFiltersWithSmartSearch() {
  ...
  if (isMusicPage) {
    ...
    console.log(`🎵 Found ${visibleIds.length} songs`);
  }
...
function initSmartSearch() {
  ...
  console.log(`   - Fuse.js: ${fuseInstance ? 'enabled' : 'disabled'}`);
  console.log(`   - Compromise.js: ${typeof nlp !== 'undefined' ? 'enabled' : 'disabled'}`);
}
