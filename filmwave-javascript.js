...
// Restore filters after they're initialized
window.addEventListener('load', function() {
  setTimeout(restoreFilterState, 1500);
});
...
// Restore favorites after songs load
window.addEventListener('load', function() {
  setTimeout(restoreFavorites, 3000);
});
